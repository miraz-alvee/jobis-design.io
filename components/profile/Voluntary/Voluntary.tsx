...
import AddVoluntary from './AddVoluntary';


interface VoluntaryItem {
    id: string;
    title: string;
...
export default function Voluntary() {
    const experiences: VoluntaryItem[] = [
        {
            id: '1',
            title: 'Code Mentor - Girls Who Code',
            ...
            contribution_description: "View Certificate",
